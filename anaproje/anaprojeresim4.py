...
# Fotoğrafı oku
resim = cv2.imread("hata ayıklama uygulama fotoğraflar/perde4.jpeg")
...
# 2️⃣ Gaussian Blur 
blur = cv2.GaussianBlur(resim, (25, 25), 10)

# 3️⃣ Canny Kenar 
kenar = cv2.Canny(gri, 30, 100)
...
# 5️⃣ Thresholding 
_, thresh = cv2.threshold(gri_kontrast, 160, 255, cv2.THRESH_BINARY)
