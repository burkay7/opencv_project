...
# Fotoğrafı oku
resim = cv2.imread("hata ayıklama uygulama fotoğraflar/tekstil3.jpeg")
...
# 2️⃣ Gaussian Blur 
blur = cv2.GaussianBlur(resim, (31, 31), 15)

# 3️⃣ Canny Kenar
kenar = cv2.Canny(gri, 30, 120)
...
# 5️⃣ Thresholding 
_, thresh = cv2.threshold(gri_kontrast, 140, 255, cv2.THRESH_BINARY)
